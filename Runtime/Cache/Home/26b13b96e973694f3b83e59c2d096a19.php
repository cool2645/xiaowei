...
<?php if(!empty($plugin["date"])): ?><link rel="stylesheet" href="/Public/Static/css/datepicker.css" /><?php endif; ?>
	...
	<?php echo W('PageHeader/adv_search',array('name'=>'我的信息','search'=>'M'));?>
			...
			<?php if(empty($list)): ?><li class="no-data">
				...
				<form method="post" action="" name="form_data" id="form_data">
					<?php if(is_array($list)): foreach($list as $key=>$vo): ?><li class="tbody">
							<div class="pull-left">
								<span class="col-10 text-center"><?php echo ($vo["doc_no"]); ?></span>
								<span class="col-10 text-center autocut"><?php echo ($vo["folder_name"]); ?></span>
							</div>
							<div class="pull-right">
								<span class="col-6 text-center "><?php echo ($vo["user_name"]); ?></span>
								<span class="col-6 text-center "><?php echo ($vo["dept_name"]); ?></span>
								<span class="col-9 text-center"><?php echo (to_date($vo["create_time"],'Y-m-d')); ?></span>
								<span class="col-6 text-center ">签收情况</span>
							</div>
							<div class="auto autocut">
