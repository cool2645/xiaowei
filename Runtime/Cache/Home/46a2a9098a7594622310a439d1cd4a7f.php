...
<?php if(!empty($plugin["date"])): ?><link rel="stylesheet" href="/Public/Static/css/datepicker.css" /><?php endif; ?>
	...
	<div class="operate panel panel-default">
		<div class="panel-body">
			...
			<div class="pull-right">
				<?php if(is_sign == 1): if(empty($sign_info)): ?><a onclick="sign()" class="btn btn-sm btn-primary">请签收</a>
						<?php else: ?>
						<a onclick="sign_info()" class="btn btn-sm btn-primary">已签收</a><?php endif; endif; ?>
	...
	<form method='post' id="frm_content" name="frm_content" enctype="multipart/form-data"  class="well form-horizontal">
		...
		<div class="form-group">
			...
			<div class="col-sm-10">
				<?php echo W('FileUpload/show',array('add_file'=>$vo['add_file'],'mode'=>'show'));?>
			</div>
		</div>
...
<script type="text/javascript">
	...
	<script type="text/javascript">
		...
		function sign_info() {
			winopen("<?php echo U('sign_info',array('id'=>$vo['id']));?>", 700, 370);
		}
