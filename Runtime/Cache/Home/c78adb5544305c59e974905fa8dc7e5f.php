...
<?php if(!empty($plugin["date"])): ?><link rel="stylesheet" href="/Public/Static/css/datepicker.css" /><?php endif; ?>
	...
	<?php echo W('PageHeader/simple',array('name'=>'编辑公告','search'=>'N'));?>

	<form method='post' id="form_data" name="form_data" enctype="multipart/form-data"  class="well form-horizontal">
		<input type="hidden" id="scope_user_id" name="scope_user_id" value="<?php echo ($vo["scope_user_id"]); ?>">
		<input type="hidden" id="scope_user_name" name="scope_user_name" value="<?php echo ($vo["scope_user_naem"]); ?>">
		...
		<div class="form-group">
			...
			<div class="col-sm-10">
				<div id="actor_wrap" class="inputbox">
					...
					<div class="wrap" >
						<span class="address_list"><?php echo (show_contact($vo["scope_user_name"],"edit")); ?></span>
						<span class="text" >
			...
			<div class="col-sm-10 row">
				<div class="checkbox col-sm-2">
					<label>
						...
						<span class="lbl">是否公开</span> </label>
				</div>
				<div class="checkbox col-sm-2">
					<label>
...
<script type="text/javascript">
	...
	<script type="text/javascript">
		function select_scope() {
			winopen("<?php echo U('Popup/scope');?>", 730, 574);
		}
		...
		$(function() {
			set_val('is_sign', "<?php echo ($vo["is_sign"]); ?>");
			set_val('is_public', "<?php echo ($vo["is_public"]); ?>");
		});
